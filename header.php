...
<head>
    ...
    <!-- <link rel="icon" href="#" sizes="16x16" type="#"> -->
    <?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
    <?php wp_body_open(); ?>
                ...
                <div class="p-header">
                    <div class="gigi-logo">
                        <a href="<?php echo esc_url( home_url('/') ); ?>">
                            <svg id="_レイヤー_1" data-name=" レイヤー 1" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 305 290">
                    ...
                    <nav class="header__nav">
                        <?php
                            wp_nav_menu(array(
                            'theme_location' => 'header-nav', //'category_navigation'に登録したメニューを表示
                            'menu_class'     => 'menu', //メニュー（カテゴリ名に当たる部分）のクラス名を変更（元々のスタイルが当たるように）
